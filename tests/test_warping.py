...
class WarpingTestMethods(unittest.TestCase):
    ...
    def test_sphere_translation_large(self):
        ...
        save_im_to_disk(im_moving, './temp/moving.nii.gz')
        save_im_to_disk(im_moving_warped, './temp/moving_warped_large.nii.gz')
    ...
    def test_brain_rotation(self):
        ...
        save_im_to_disk(im_moving, './temp/brain_moving.nii.gz')
        save_im_to_disk(im_moving_warped, './temp/brain_moving_warped.nii.gz')
